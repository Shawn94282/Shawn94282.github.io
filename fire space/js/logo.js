var Logo = function (time, scale, loop, backColor, color, textArr) {
	var game   = js.game;           // Game Manager
	var point  = js.vector.point;   // Constructor for Point
	var brush  = js.brush;          // Brush, used for simple drawing
	var OOP    = js.OOP;            // Object's manager
